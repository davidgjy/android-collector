 ...
 */
public class ContractListActivity extends SingleFragmentActivity {
    ...
    public static Intent newIntent(Context packageContext, LoginResult result) {
        Intent intent = new Intent(packageContext, ContractListActivity.class);
    ...
    protected Fragment createFragment() {
        ...
        return ContractListFragment.newInstance(userId, token);
    }
}

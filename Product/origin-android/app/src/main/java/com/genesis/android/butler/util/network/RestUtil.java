package com.genesis.android.butler.util.network;
...
public class RestUtil {
    ...
    public static RestTask obtainFormPostTask(String url,
            String formData) throws MalformedURLException,
            IOException {
        HttpURLConnection connection = (HttpURLConnection) (new URL(url))
                .openConnection();
...
//        connection.addRequestProperty("X-Rescue-From", "android");
//        connection.addRequestProperty("X-User-Type", "rescue");
    ...
    public static RestTask obtainAuthPostTask(String url, String formData, String userId, String token)
            throws MalformedURLException, IOException {
        HttpURLConnection connection = (HttpURLConnection) (new URL(url))
                .openConnection();
        ...
        connection.addRequestProperty("X-User-Id", userId);

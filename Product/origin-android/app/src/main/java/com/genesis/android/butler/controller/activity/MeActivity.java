...
import com.genesis.android.butler.controller.fragment.MeFragment;
...
public class MeActivity extends SingleFragmentActivity {
    public static Intent newIntent(Context packageContext, LoginResponse response) {
        Intent intent = new Intent(packageContext, MeActivity.class);
    ...
    protected Fragment createFragment() {
        ...
        return MeFragment.newInstance(userId, token);
    }
}
